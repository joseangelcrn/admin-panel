...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::prefix('task')->name('task.')->group(function () {
        ...
        Route::group(['middleware' => ['role:admin']], function () {
            ...
            Route::get('/list-completed-verified',[TaskController::class,'completedAndVerifiedList'])->name('list-completed-verified');
            ...
            Route::post('/verify/{id}', [TaskController::class,'verify'])->name('verify');
        });
